...
const Footer = () => {
  return (
    <footer className="bg-[#212529] py-6">
      <div className="container mx-auto px-4">
        {/* Image grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link to="https://mohfw.gov.in/" className="flex justify-center">
            <img
              width="240"
              alt="Health"
          ...
          <Link to="https://www.meity.gov.in/" className="flex justify-center">
            <img
              width="200"
              alt="India"
              className="max-w-full h-12 md:h-14"
          ...
          <Link to="https://www.nic.in/" className="flex justify-center">
            <img
              width="240"
              alt="NIC Logo"
              className="max-w-full h-12 md:h-14"
